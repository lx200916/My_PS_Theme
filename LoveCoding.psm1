...
function Write-Theme {
    ...
    $prompt = Write-Prompt -Object " I $($sl.PromptSymbols.StartSymbol) $($sl.PromptSymbols.MyLove) " -ForegroundColor $sl.Colors.PromptForegroundColor -BackgroundColor $sl.Colors.WithBackgroundColor
    ...
    $computer =$sl.PromptSymbols.WindowsSymbol
    ...
    if (Test-VirtualEnv) {
        ...
        $prompt += Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol)" -ForegroundColor $sl.Colors.PromptUserBackgroundColor -BackgroundColor $sl.Colors.PathColor
    }

    # Writes the drive portion
    #$prompt += Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol)" -ForegroundColor $sl.Colors.PromptIndicatorForegroundColor3 -BackgroundColor $sl.Colors.PromptUserBackgroundColor
    $prompt += Write-Prompt -Object " $path " -ForegroundColor $sl.Colors.PromptForegroundColor -BackgroundColor $sl.Colors.PathColor
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PathColor -BackgroundColor $sl.Colors.PromptIndicatorForegroundColor2

    $status = Get-VCSStatus
    if ($status) {
        $themeInfo = Get-VcsInfo -status ($status)
        $lastColor = $themeInfo.BackgroundColor
        $prompt += Write-Prompt -Object " $($themeInfo.VcInfo) " -BackgroundColor $sl.Colors.PromptIndicatorForegroundColor2 -ForegroundColor $sl.Colors.GitForegroundColor
    }
    ...
    If ($lastCommandFailed) {
        $prompt += Write-Prompt -Object " $($sl.PromptSymbols.FailedCommandSymbol) " -ForegroundColor $sl.Colors.CommandFailedIconForegroundColor -BackgroundColor $sl.Colors.PromptIndicatorForegroundColor2
    } else {
        $prompt += Write-Prompt -Object " $($sl.PromptSymbols.SuccessCommandSymbol) " -ForegroundColor $sl.Colors.CommandSuccessIconForegroundColor -BackgroundColor $sl.Colors.PromptIndicatorForegroundColor2
    }
   $prompt += Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol) " -ForegroundColor $sl.Colors.PromptIndicatorForegroundColor2 
...
$sl.PromptSymbols.MyLove= "Coding"
$sl.PromptSymbols.StartSymbol = [char]::ConvertFromUtf32(0xf7d0)
$sl.PromptSymbols.WindowsSymbol = [char]::ConvertFromUtf32(0xe70f)
$sl.PromptSymbols.PromptIndicator = [char]::ConvertFromUtf32(0x276F)
$sl.PromptSymbols.SegmentForwardSymbol = [char]::ConvertFromUtf32(0xE0B0) #(0xE0B0)
...
$sl.Colors.PathColor=[ConsoleColor]::DarkRed
...
$sl.Colors.PromptUserBackgroundColor = [ConsoleColor]::DarkBlue